package com.quizapp.command;

import com.quizapp.config.DrivingSchoolConfiguration;
import com.quizapp.exception.DownstreamFailureException;
import com.quizapp.util.RESTInvoker;
...
import static com.quizapp.config.DrivingSchoolConstants.ServiceCommand.HTTP_STATUS_NOT_FOUND;
